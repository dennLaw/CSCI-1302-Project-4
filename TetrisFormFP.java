    ...
    public void previewQueue(int paneNum, int blockType){
    	...
    	if (paneNum == 1){
    		...
    		if (blockType == 1){
    			...
    			nextQueue2.setIcon(piecePic);
    		}
    		
    		else if (blockType == 2){
    			ImageIcon piecePic = new ImageIcon(projPath + "\\art\\2Jbeam.png");
    			nextQueue2.setIcon(piecePic);
    		}
    		
    		else if (blockType == 3){
    			ImageIcon piecePic = new ImageIcon(projPath + "\\art\\3Lbeam.png");
    			nextQueue2.setIcon(piecePic);
    		}
    		
    		else if (blockType == 4){
    			ImageIcon piecePic = new ImageIcon(projPath + "\\art\\4Square.png");
    			nextQueue2.setIcon(piecePic);
    		}
    		
    		else if (blockType == 5){
    			ImageIcon piecePic = new ImageIcon(projPath + "\\art\\5Sbeam.png");
    			nextQueue2.setIcon(piecePic);
    		}
    		
    		else if (blockType == 6){
    			ImageIcon piecePic = new ImageIcon(projPath + "\\art\\6Tbeam.png");
    			nextQueue2.setIcon(piecePic);
    		}

    		else if (blockType == 7){
    			ImageIcon piecePic = new ImageIcon(projPath + "\\art\\7Zbeam.png");
    			nextQueue2.setIcon(piecePic);
    		}
